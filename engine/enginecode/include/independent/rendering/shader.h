...
namespace Engine {
	...
	*/
	...
	public:
		...
		virtual uint32_t getRenderID() const = 0; //!< Get the render ID
		...
		virtual void uploadFloat2(const char* name, glm::vec2& value) = 0;//!< Upload a float2 to the shader
		virtual void uploadFloat3(const char* name, glm::vec3& value) = 0;//!< Upload a float3 to the shader
		virtual void uploadFloat4(const char* name, glm::vec4& value) = 0;//!< Upload a float4 to the shader
		virtual void uploadMat4(const char* name, glm::mat4& value) = 0;//!< Upload a mat4 to the shader
